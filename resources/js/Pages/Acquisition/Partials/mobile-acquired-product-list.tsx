...
const MobileAcquiredProductsList: React.FC<AcquiredProductsListProps> = ({ products, onEditProduct, showEditConfirmation, onConfirmEditProduct, onRemoveProduct, onCancelEditProduct }) => {
...
export default MobileAcquiredProductsList
